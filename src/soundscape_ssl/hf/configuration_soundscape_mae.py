"""Configuration for the released Soundscape-MAE models.
...
class SoundscapeMAEConfig(PretrainedConfig):
    """Config for :class:`SoundscapeMAEModel` and its classification head.
